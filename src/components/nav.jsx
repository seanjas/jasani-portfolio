    ...
    <nav className="bg-gray-900 text-white shadow-md fixed top-0 w-full z-50">
      <div className="container mx-auto flex items-center justify-between p-5 md:p-8">
        ...
        <div className="space-x-6 hidden md:flex">
          <a href="#about" className="hover:bg-gray-700 px-4 py-2 rounded-full transition duration-300">About</a>
          <a href="#resume" className="hover:bg-gray-700 px-4 py-2 rounded-full transition duration-300">Resume</a>
          <a href="#certificate" className="hover:bg-gray-700 px-4 py-2 rounded-full transition duration-300">Certifications</a>
        </div>
      ...
      <div className="md:hidden bg-gray-800 text-white">
        ...
        <a href="#certificate" className="block px-4 py-2 hover:bg-gray-700">Certifications</a>
      </div>
    </nav>
  );
};
